...
class ChatBotViewController: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        doneButton.addTarget(self, action: #selector(goToPlataform), for: .touchUpInside)
        ...
        NSLayoutConstraint.activate([
            ...
            myCollection.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -220),
            ...
            doneView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -10),
            doneView.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            doneView.widthAnchor.constraint(equalToConstant: 300),
            doneView.heightAnchor.constraint(equalToConstant: 200),
            
            doneLabel.topAnchor.constraint(equalTo: doneView.topAnchor, constant: 10),
            ...
            doneButton.topAnchor.constraint(equalTo: doneView.topAnchor, constant: 120),
        ...
        self.addAnswersToButton(index: self.indexTrack)
    }
    ...
    func configureAnswersButtons(){
        ...
        answer1.titleLabel?.textAlignment = .center
        answer1.titleLabel?.font = UIFont(name: "SFCompactDisplay-Regular", size: 10)
        answer1.addTarget(self, action: #selector(sendToBot), for: .touchUpInside)
        ...
        answer2.titleLabel?.textAlignment = .center
        answer2.titleLabel?.font = UIFont(name: "SFCompactDisplay-Regular", size: 10)
        answer2.addTarget(self, action: #selector(sendToBot), for: .touchUpInside)
        ...
        answer3.titleLabel?.textAlignment = .center
        answer3.titleLabel?.font = UIFont(name: "SFCompactDisplay-Regular", size: 10)
        answer3.addTarget(self, action: #selector(sendToBot), for: .touchUpInside)
        ...
        answer4.titleLabel?.textAlignment = .center
        answer4.titleLabel?.font = UIFont(name: "SFCompactDisplay-Regular", size: 10)
        answer4.addTarget(self, action: #selector(sendToBot), for: .touchUpInside)
        answer3.contentMode = .center
        ...
        //constraints
        NSLayoutConstraint.activate([
            answer1.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -120),
            answer1.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -90),
            answer1.widthAnchor.constraint(equalToConstant: 170),
            answer1.heightAnchor.constraint(equalToConstant: 80),
            
            answer2.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -120),
            answer2.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 90),
            answer2.widthAnchor.constraint(equalToConstant: 170),
            answer2.heightAnchor.constraint(equalToConstant: 80),
            
            answer3.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -20),
            answer3.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -90),
            answer3.widthAnchor.constraint(equalToConstant: 170),
            answer3.heightAnchor.constraint(equalToConstant: 80),
            
            answer4.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -20),
            answer4.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 90),
            answer4.widthAnchor.constraint(equalToConstant: 170),
            answer4.heightAnchor.constraint(equalToConstant: 80)
...
//    }
    ...
    func talkToBot(with text:String) {
        if labelBefore.isHidden == false {
            labelBefore.isHidden = true
        }
        save(text)
    ...
    func addAnswersToButton(index: Int) {
        switch index {
        case 1:
            self.answer1.setTitle("Oi, por que não me conta melhor o seu relato?", for: .normal)
            self.answer2.setTitle("Oi, já passei por algo parecido…", for: .normal)
            self.answer3.setTitle("Olá, quer me explicar melhor como foi?", for: .normal)
            self.answer4.setTitle("Ei, aconteceu comigo também.", for: .normal)
        case 2:
            self.answer1.setTitle("Nossa, totalmente, sempre percebo isso.", for: .normal)
            self.answer2.setTitle("Quase nunca percebo.", for: .normal)
            self.answer3.setTitle("Até que noto, sim, mas não sempre.", for: .normal)
            self.answer4.setTitle("Não mesmo, acho muito difícil.", for: .normal)
        case 3:
            self.answer1.setTitle("Sempre, sou quase a confidente de todo mundo.", for: .normal)
            self.answer2.setTitle("Olha, até acontece mas não é frequente.", for: .normal)
            self.answer3.setTitle("Quase nunca acontece comigo.", for: .normal)
            self.answer4.setTitle("Não, não consigo conversar com eles assim.", for: .normal)
        case 4:
            self.answer1.setTitle("Nunca consigo, também acho difícil isso…", for: .normal)
            self.answer2.setTitle("Consigo, mas não é sempre.", for: .normal)
            self.answer3.setTitle("É bem raro eu conseguir.", for: .normal)
            self.answer4.setTitle("Não acho difícil, sempre consigo entender.", for: .normal)
    ...
    @objc func sendToBot(on button:UIButton) {
    ...
    @objc func goToPlataform() {
        MeUser.instance.tutorial = "Done"
        DAOManager.instance?.ckUsers.edit(meUser: MeUser.instance, requester: self)
...
extension ChatBotViewController: UserRequester {
    
    func saved(userRecord: CKRecord?, userError: Error?) {
        if userError != nil {
            debugPrint(userError!, #function)
