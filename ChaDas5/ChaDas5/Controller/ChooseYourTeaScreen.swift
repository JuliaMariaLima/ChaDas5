...
// MARK: -  Declaration
class ChooseYourTeaScreen: UIViewController {
...
extension ChooseYourTeaScreen: UICollectionViewDelegate, UICollectionViewDataSource {
