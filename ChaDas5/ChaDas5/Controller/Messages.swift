...
//        messageIsEditing =  false
//
//        ChannelManager.instance.preLoad(requester: self)
//
//
//    }
//
...
//        if ChannelManager.instance.channels.count == 0 {
...
//        return ChannelManager.instance.channels.count
//    }
//
...
//
//        if ChannelManager.instance.channels.isEmpty {
//            return messagesCell
//        } else {
//            let channel = ChannelManager.instance.channels[indexPath.row]
//
//            var username: String?
